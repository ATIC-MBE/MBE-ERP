...
class Util {
      ...
      getPathApi(role: CodeRoleType): any {
            switch (role) {
                  ...
                  case Constants.code_rol_aca:
                        return ApiAccess.aca || []
                  ...
                  case Constants.code_rol_myd:
                        return ApiAccess.myd || []
                  case Constants.code_rol_mydmaster:
                        return ApiAccess.mydmaster || []
                  ...
                  case Constants.code_rol_acamaster:
                        return ApiAccess.acamaster || []
      ...
      createSign(appsecret: string, message: string): string {
            ...
            let _theSign = crypto.createHmac('sha256', appsecret).update(_buffer.toString()).digest('base64')
