...
const Constants = { 
      ...
      code_rol_acamaster : 'acamaster',
      code_rol_aticmaster : 'aticmaster',
      code_rol_mydmaster : 'mydmaster',
      ...
      // Tablas MYD (antes RMG)
      tbl_plataforma_comercial_myd_sql: 'tbl_plataforma_comercial_myd',
      tbl_tipo_estancia_myd_sql: 'tbl_tipo_estancia_myd',
      tbl_info_piso_comercial_myd_sql: 'tbl_info_piso_comercial_myd',
      tbl_plataforma_infopiso_myd_sql: 'tbl_plataforma_infopiso_myd',
      tbl_variables_reserva_myd_sql: 'tbl_variables_reserva_myd',
      ...
      getRoles: (): Array<CodeRoleType> => {
            return [
                  ...
                  Constants.code_rol_aca as CodeRoleType,
                  ...
                  Constants.code_rol_myd as CodeRoleType,
                  Constants.code_rol_mydmaster as CodeRoleType,
                  ...
                  Constants.code_rol_acamaster as CodeRoleType
            ]
      },
