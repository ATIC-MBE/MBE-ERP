...
class EmailService {
    ...
    private _emailFrom = "Master In Business Entrepreneur"
    private _emailSubject = "Master In Business Entrepreneur"
    private _bodyEmail = "<h1>Bienvenido a MBE!! &#128520;&#128520; jajajaja</h1>"
