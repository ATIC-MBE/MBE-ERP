...
const ProgresoMydmaster = () => {
    const _itemSelected = 'mydmaster_progreso'
    ...
    const fetchEmployeeData = async () => {
        try {
            ...
            // Fallback final: usar un usuario por defecto si no se puede identificar
                ...
                userIdentifier = 'Usuario Mydmaster'
            }
        ...
        return (
            <Layout>
                <div className="h-100 bg-image p-5 pt-2 flex">
                    <MenuLeftContainer data={menu_myd_master} itemSelected={_itemSelected} />
                    <ContentContainer>
...
export default ProgresoMydmaster