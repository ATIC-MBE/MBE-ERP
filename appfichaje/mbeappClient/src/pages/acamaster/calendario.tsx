...
const CalendarioAcaMaster = () => {
    const _itemSelected = 'aca_master_calendario'
                ...
                <ContentContainer>
                    <div className="p-6">
                        ...
                        <div style={{ height: '650px' }}>
                            <DepartmentCalendar
                                department="aca"
                                userRole={currentUserData?.roles || 'aca_master'}
                            />
                        </div>
                    </div>
                </ContentContainer>
...
export default CalendarioAcaMaster