...
import { menu_myd, STATES, ALERT_DANGER, USER_DEPARMENT } from '@/client/helpers/constants';
...
import { AiFillSave, AiOutlineCalendar, AiOutlineComment } from 'react-icons/ai';
...
const SolicitudDetalle = () => {
    ...
    const { dataDB, handleChange, handleSave, handleCancel, errorValidate, msgError, roles } = useVacacionesIddShare(_pathGoToBack);
