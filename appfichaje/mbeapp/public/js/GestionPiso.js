...
const GestionPiso = {
      ...
      actionOpenPortalOLD: (idDevice = 0) => {
            ...
            const dataJSON = {      cmd: Constants.ACTION_OPENPORTAL, 
      ...
      actionOpenLock: (idDevice = 0) => {
            ...
            const dataJSON = {      cmd: Constants.ACTION_OPENLOCK, 
                                    client: codeDeviceTarget, 
                                    clientFrom: clientFromID, 
                                    user, 
                                    role,
      ...
      actionNewCode: (idDevice = 0) => {
            ...
            const dataJSON = {      cmd: Constants.ACTION_NEWCODE, 
                                    client: codeDeviceTarget, 
                                    clientFrom: clientFromID, 
                                    days: dayF, 
                                    code: codeF, 
      ...
      actionSetCard: (idDevice = 0) => {
            ...
            const dataJSON = {      cmd: Constants.ACTION_SETCARD, 
                                    client: codeDeviceTarget, 
                                    clientFrom: clientFromID, 
                                    type: typeF, 
                                    Qr: qRF.trim(), 
      ...
      actionSyncTime: (idDevice = 0) => {
            ...
            const dataJSON = {      cmd: Constants.ACTION_SYNCTIME, 
                                    client: codeDeviceTarget, 
                                    clientFrom: clientFromID, 
                                    syncTime,
                                    user,
      ...
      actionToggleDevice: (stateSONOFF = 'NA', idDevice = 0) => {
            ...
            fetch('/update', {
                  ...
                  body: JSON.stringify({ cmd: Constants.ACTION_TOGGLELIGHT, client: codeDeviceTarget, user, role, idDevice,
                        idPiso: idPiso })
            })
            .then(res => res.json())
            .then(res=> {
